...
public class PuttingEverythingTogether {
    ...
    public static String roomDescription(boolean hasKey) {
        if (hasKey == true) {
            ...
            return "In the right corner there is an old desk with a chair.\n"
        ...
        switch (object) {
            ...
            case "door":
                if (hasKey == true) {
                    ...
                    return "You pull at the handle and bang at the door. It doesn't give way and no one hears. At least that's what it seems like. If you're going to get out, you're going to need a key.";
                }
            default:
